...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen duration-300">
      ...
      {/* Logo*/}
      <div className="absolute top-6 left-6 font-extrabold text-lg flex items-center hover:cursor-pointer" onClick={() => Navigate("/home")}>
      ...
      <div
        ...
        ${mode === "register" ? "items-start pt-24 sm:items-center lg:pt-0" : "items-center"}
        `}
      >
