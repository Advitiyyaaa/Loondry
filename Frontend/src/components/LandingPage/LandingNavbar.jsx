...
export default function LandingNavbar({ theme }) {
    ...
    const showShadow = offset < 60; // solid card at top
    const glassMode = offset >= 60; // glass after scroll
    ...
    return (
        <nav className={`fixed top-0 left-0 w-full z-50 ${!showShadow ? "p-2" : "p-3 lg:p-5"} transition-all duration-500 overflow-visible`}>
            <div className="relative max-w-[95%] lg:max-w-7xl lg:mx-auto">
                ...
                {/* Foreground Navbar */}
                <div
                className={`relative z-10 flex items-center justify-between border-2 px-3 lg:px-6 ${!showShadow?"py-1.5":"py-3"} transition-all duration-500
                ${
                showShadow
                    ? theme === "dark"
                    ...
                    : theme === "dark"
                    ? "bg-black/20 backdrop-blur-md border-transparent text-white"
                    : "bg-white/20 backdrop-blur-md border-transparent text-black"
                }`}
                >
                    {/* Logo */}
                    <div className="justify-self-start font-extrabold text-base lg:text-lg flex items-center hover:cursor-pointer" onClick={() => navigate("/home")}>
                    ...
                    <div className="flex items-center gap-0.5 sm:gap-3">
                        ...
                        className={`px-1.5 py-2 sm:px-5 text-xs md:text-sm font-medium transition
                            ${
                            showShadow
                                ? theme === "dark"
                                ? "hover:bg-white/10"
                        ...
                        className={`px-1.5 sm:px-5 py-2 text-xs md:text-sm font-semibold transition 
                            ${
                            showShadow
                                ? theme === "dark"
