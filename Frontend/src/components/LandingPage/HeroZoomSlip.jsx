        ...
        <div className="w-full flex justify-center overflow-hidden">
          ...
          >
            <div className="flex justify-center flex-col items-center">
              <h1 className="text-5xl lg:text-7xl max-w-4xl font-bold tracking-tight leading-[1.1]">
                Laundry, Engineered.
              </h1>

              <p className="mt-4 sm:mt-8 text-sm md:text-xl lg:text-2xl max-w-3xl lg:max-w-4xl text-gray-500 dark:text-gray-400 leading-relaxed">
